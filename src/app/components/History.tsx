...
export default function History() {
    return (
        <div className="flex justify-between items-center flex-wrap w-full">
            <div className="flex flex-col w-full md:w-1/3 md:h-full mb-6 md:mb-0">
                <h2 className="text-4xl text-yellow-400 md:text-right">About Us</h2>
                <FaSpoon className="mb-3 md:ml-auto" />
            ...
            <div className=" flex flex-col  w-full md:w-1/3 md:h-full mt-6 md:mt-0 ">
